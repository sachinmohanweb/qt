        ...
        $('#products-table').DataTable({
            ...
            columns: [
                ...
                { 
                    ...
                    render: function(data, type, row) {
                        if (data) {
                            return `<img src="/images/products/${data}" alt="${row.name}" style="height: 40px; width: 40px; object-fit: cover; border-radius: 4px;">`;
                        } else {
                            return `<div style="height: 40px; width: 40px; background-color: #f3f4f6; border-radius: 4px; display: flex; align-items: center; justify-content: center;"><i class="fas fa-image text-secondary"></i></div>`;
                        }
                    }
            ...
            columns: [
                ...
                { 
                    ...
                    render: function(data) {
                        ...
                        if (data === 'read') badgeClass = 'secondary';
                        else if (data === 'replied') badgeClass = 'success';
                        else if (data === 'archived') badgeClass = 'warning';
