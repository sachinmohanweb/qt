    ...
    @include('common.header')
      ...
      <section>
         <div
            ...
            style="background: url(web_img/h1.jpg)"
            >
            <h1>Design</h1>
         </div>
      </section>
      ...
      <div class="design-sec">
         <div class="container">
            <div class="design-content"><p>At QOT Constructions, our design services focus on creating spaces that are not only visually appealing but also highly functional and tailored to each client’s lifestyle or business needs. We believe that great design begins with a deep understanding of purpose, space, and aesthetics.

Our experienced design team works across a wide spectrum of projects, including residential homes, commercial spaces, offices, retail outlets, hospitality projects, and institutional buildings. Each concept is developed with careful attention to detail, user experience, and sustainability.

From architectural planning and spatial layout to material selection and visual presentation, we offer end-to-end design solutions that align with your vision, budget, and timeline.

At QOT Constructions, we don’t just design spaces — we design experiences that inspire, elevate, and endure.
