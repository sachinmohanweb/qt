...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body text-center">
                    @if($service->image)
                        <img src="{{ asset('storage/projects/' . $service->image) }}" alt="{{ $service->name }}" class="img-fluid rounded mb-3" style="max-height: 300px;">
                    @else
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <span class="badge badge-primary">{{ $service->MenuItem->name }}</span>
        ...
        <div class="col-md-8">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $service->ProjectImages->count() }} images</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            @if($service->ProjectImages->count() > 0)
                <div class="card">
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @foreach($service->ProjectImages as $gallery)
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img src="{{ asset('storage/project_images/' . $gallery->image) }}" class="card-img-top" style="height: 150px; object-fit: cover;">
